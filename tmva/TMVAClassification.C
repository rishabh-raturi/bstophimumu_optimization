...
int TMVAClassification( TString myMethodList = "" )
{
   ...
   // (it is also possible to use ASCII format as input -> see TMVA Users Guide)
    ...
    ch->Add("./SIGNAL_forBDT_Training.root");
    TTree *sigtr = ch;

    TChain *ch1 = new TChain("tree");
    ch1->Add("./BKG_ForBDT_Training.root");
    TTree *bkgtr= ch1;
   ...
   dataloader->AddVariable( "Max_Kpt := TMath::Max(Kmpt,Kppt)",                     'F' );
   dataloader->AddVariable( "Max_Mpt := TMath::Max(Mumpt,Muppt)",                   'F');
   dataloader->AddVariable( "Max_K_MinIP := TMath::Max(KmtrkMinIP,KptrkMinIP)",     'F' );
   ...
   dataloader->AddSpectator( "Bmass",          "Spectator1",   "GeV",  'F' );
   dataloader->AddSpectator( "Mumumass",       "Spectator2",   "GeV",  'F' );
   dataloader->AddSpectator( "Mumumasserr",    "Spectator3",   "GeV",  'F' );
   dataloader->AddSpectator( "Kmpt",           "Spectator4",   "GeV",  'F' );
   dataloader->AddSpectator( "Kppt",           "Spectator5",   "GeV",  'F' );
   dataloader->AddSpectator( "Kmtrkdcasigbs",  "Spectator6",   "GeV",  'F' );
   dataloader->AddSpectator( "Kptrkdcasigbs",  "Spectator7",   "GeV",  'F' );
