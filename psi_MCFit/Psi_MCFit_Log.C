...
void Psi_MCFit_Log()
{
	...
	RooRealVar  mean("mean","common means for Crystal Balls", 5.367, bm_min, bm_max);
        ...
        //RooRealVar  alpha2("alpha2","alpha for CB2", 0.1, 5.);
	...
	// plotting individual crystal ball in the frame
        //model.plotOn(xframe, RooFit::Name("CB1"), Components("CB1"), FillColor(kBlue-2), FillStyle(3001), DrawOption("F"));
	...
	TPaveText* paveText = new TPaveText(0.62,0.60,0.80,0.88,"NDC");
	 ...
	 TLatex *mark = new TLatex();
        ...
        mark->DrawLatex(0.65,startY,"#scale[0.8]{1753.623 fb^{-1} (13 TeV)}");
        mark->Draw();
