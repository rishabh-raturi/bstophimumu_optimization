...
void Jpsi_MCFit()
{
	...
	TCanvas *c = new TCanvas("c","c",1400,1500);
	...
	TPaveText* paveText = new TPaveText(0.65,0.70,0.83,0.88,"NDC");
	...
	paveText->AddText(Form("#mu  = %.5f #pm %.5f GeV" , mean.getVal() , mean.getError()));
