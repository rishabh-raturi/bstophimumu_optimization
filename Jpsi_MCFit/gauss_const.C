...
void gauss_const()
{
	...
	ch->Add("/home/rishabh/project/root_files/val/2016/red_ntuples/PhiMuMu_MC_ForFit.root");
    	TTree *tr = ch;
	...
	ch1->Add("/home/rishabh/project/root_files/val/2016/red_ntuples/PhiMuMu_Data_ForFit.root");
	TTree *tr1 = ch1;
	...
	c->SaveAs("rare_MCFit_2016_Log_q2.pdf");
	c->SaveAs("rare_MCFit_2016_Log_q2.png");

	c2->SaveAs("rare_MCFit_2016_q2.pdf");
	c2->SaveAs("rare_MCFit_2016_q2.png");

	c3->SaveAs("rare_DataFit_2016_q2.pdf");
	c3->SaveAs("rare_DataFit_2016_q2.png");
}
